...
namespace LostLands
{
    class IntroScreen : Screen
    {
            ...
            : base(game)
        {
            ...
            newGameB = new button(300, 250 - 35, Content.Load<Texture2D>(@"Buttons\newGame"), Content.Load<Texture2D>(@"Buttons\newGame(2)"), Content.Load<Texture2D>(@"Buttons\newGame(3)"));
            option = new button(300, 250 + 35, Content.Load<Texture2D>(@"Buttons\option"), Content.Load<Texture2D>(@"Buttons\option(2)"), Content.Load<Texture2D>(@"Buttons\option(3)"));
            exitB = new button(800 - 25, 600 - 25, Content.Load<Texture2D>(@"Buttons\exit"), Content.Load<Texture2D>(@"Buttons\exit(2)"), Content.Load<Texture2D>(@"Buttons\exit(3)"));
        }
